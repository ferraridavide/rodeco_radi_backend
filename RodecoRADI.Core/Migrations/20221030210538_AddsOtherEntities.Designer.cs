...
namespace RodecoRADI.Core.Migrations
{
    ...
    [Migration("20221030210538_AddsOtherEntities")]
    partial class AddsOtherEntities
    {
            ...
            modelBuilder.Entity("RodecoRADI.Core.Persistance.Models.Tunnel", b =>
                {
                    ...
                    b.Property<string>("LenghtEntrancePortal")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RodecoRADI.Core.Persistance.Models.Bridge", b =>
                {
                    ...
                    b.OwnsOne("RodecoRADI.Core.Persistance.Models.EnumOrCustom<RodecoRADI.Core.Persistance.Models.BridgePavementMaterial>", "PavementTransverseFall", b1 =>
                        {
                            b1.Property<Guid>("BridgeId")
                                .HasColumnType("uniqueidentifier");
